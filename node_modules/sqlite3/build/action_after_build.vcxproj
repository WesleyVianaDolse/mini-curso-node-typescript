...
<Project DefaultTargets="Build" ToolsVersion="14.0" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  ...
  <PropertyGroup Label="Globals">
    <ProjectGuid>{6AE75610-D549-D806-1A98-12B20E92586D}</ProjectGuid>
  ...
  <ItemGroup>
    <CustomBuild Include="$(OutDir)\node_sqlite3.node">
      ...
      <Command>call mkdir &quot;C:\dev\mini-curso-node-typescript\node_modules\sqlite3\lib\binding\node-v93-win32-x64&quot; 2&gt;nul &amp; set ERRORLEVEL=0 &amp; copy /Y &quot;$(OutDir)node_sqlite3.node&quot; &quot;C:\dev\mini-curso-node-typescript\node_modules\sqlite3\lib\binding\node-v93-win32-x64\node_sqlite3.node&quot;&#xD;&#xA;if %errorlevel% neq 0 exit /b %errorlevel%</Command>
      <Message>Copying $(OutDir)/node_sqlite3.node to C:\dev\mini-curso-node-typescript\node_modules\sqlite3\lib\binding\node-v93-win32-x64</Message>
      <Outputs>C:\dev\mini-curso-node-typescript\node_modules\sqlite3\lib\binding\node-v93-win32-x64\node_sqlite3.node</Outputs>
    </CustomBuild>
  </ItemGroup>
  <ItemGroup>
    <ProjectReference Include="node_sqlite3.vcxproj">
      <Project>{114F5E22-A817-6C1C-C910-A1D67D8E8BFD}</Project>
